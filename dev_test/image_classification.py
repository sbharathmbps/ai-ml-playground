import os
HF_BASE = "/input/VLM_input/huggingface_cache"
...
ASSET_LABELS = [
    "single electrical utility pole with wires insulators and transformer",
    "tall transmission tower with lattice steel framework",
    "domestic gas pipeline network with valves elbows flanges and meters at ground level",
    "close-up smooth white composite wind turbine fragment against sky",
    "indoor industrial steel coil with straps pallets and loading equipment",
    "close-up view of outdoor electrical substation with concrete structures cracks transformers circuit breakers isolators busbars insulators control cabinets and grounding structures"
]

LABEL_TO_ASSET = {
    ASSET_LABELS[0]: "ELECTRICAL UTILITY POLE",
    ASSET_LABELS[1]: "TRANSMISSION TOWER",
    ASSET_LABELS[2]: "GAS PIPELINE",
    ASSET_LABELS[3]: "WIND TURBINE FRAGMENT",
    ASSET_LABELS[4]: "STEEL COIL",
    ASSET_LABELS[5]: "SUBSTATION EQUIPMENT"
}
...
def classify_image(image):
    ...
    return {
        "predicted_asset": LABEL_TO_ASSET[top["label"]],
    ...
    try:        
        for row in image_id_list:
            ...
            detection_list.append({
                ...
                "predicted_asset": str(output["predicted_asset"]),                            
